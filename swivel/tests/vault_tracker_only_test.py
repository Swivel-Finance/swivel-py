...
C_TOKEN_ADDR = '0x6d7f0754ffeb405d23c51ce938289d4835be3b14'
SWIVEL_ADDR = '0x8e7bFA3106c0544b6468833c0EB41c350b50A5CA'
...
def vault_tracker(vendor):
    ...
    c_token_addr = vendor.instance.toChecksumAddress(C_TOKEN_ADDR)
    tx_hash = deployed.constructor(123456789, c_token_addr, SWIVEL_ADDR).transact()
